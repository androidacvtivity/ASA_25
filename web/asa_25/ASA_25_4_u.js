...
webform.afterLoad.asa23 = function () {
    if (!Drupal.settings.mywebform.preview) {
        ...
        // CFP / Titlu R5 C31 (Proprietate) - static classifier
        set_cfp_to_select('TITLU_R5_C31');

        // CFOJ / Titlu R1 C31 (Forma organizatorico-juridică) - static classifier
...
(function ($) {
  Drupal.behaviors.asa23StaticClassifiers = {
    attach: function (context, settings) {
      if (Drupal.settings && Drupal.settings.mywebform && Drupal.settings.mywebform.preview) {
        return;
      }
